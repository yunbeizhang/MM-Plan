...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        # TODO(developer): 1. support create from random initialized model. 2. Support init with FSDP directly
        ...
        with init_context(), warnings.catch_warnings():
            ...
            # some parameters may not in torch_dtype. TODO(developer) remove this after we switch to fsdp2
        ...
        if self._is_rollout and self.config.rollout.name == "hf":
            # TODO(developer, developer) fix me. Current, auto_wrap_policy causes HFRollout to hang in Gemma
